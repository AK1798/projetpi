...
ObservableList<String> etatlist = FXCollections.observableArrayList("en attente","Livré","annuler");
    ...
    {
        boolean isDateEmpty = mounira.validation.DatePickerValidation.isDatePickerNotEmpty(date, error_date, "Choisir un date valide");
        boolean isUserNumber = mounira.validation.TextFieldValidation.isTextFieldTypeNumber(id_user, error_user, "Choisir un nombre valide");
