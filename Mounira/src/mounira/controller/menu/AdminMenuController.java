...
public class AdminMenuController implements Initializable {
    ...
    private void handleAddMenu(ActionEvent event){
        ...
        boolean isTitreString = mounira.validation.TextFieldValidation.isTextFieldTypeString
        (txt_titre, error_titre, "Le titre doit être une chaine de caractères");
        boolean isDescriptionString = mounira.validation.TextFieldValidation.isTextFieldTypeString
        (txt_description, error_description, "La description doit être une chaine de caractères");
        boolean isPrixNumber = mounira.validation.TextFieldValidation.isTextFieldTypeNumber
        (txt_prix, error_prix, "Le prix doit être un nombre");
        boolean isIngredientsString = mounira.validation.TextFieldValidation.isTextFieldTypeString
        (txt_ingredients, error_ingredients, "Les ingredients doit être une chaine de caractères");
        boolean isCategorieEmpty = mounira.validation.ComboBoxValidation.isComboBoxNotEmpty
        (txt_categorie, error_categorie, "La catégorie est requis");
        boolean isImageViewEmpty = mounira.validation.ImageViewValidation.isImageViewEmpty
    ...
    private void handleReturnMenu(ActionEvent event) throws Exception {
        SceneChanger.changeToScene(getClass(), event, "/mounira/view/user/MainFXML.fxml");
    }
