...
import mounira.entite.Ingredients;
import java.net.URL;
...
import mounira.service.menu.IngredientsService;
...
public class AdminIngredientsController implements Initializable {
    ...
    private void handleAddIngredient(ActionEvent event) {
        boolean isNomString = mounira.validation.TextFieldValidation.isTextFieldTypeString
    ...
    private void handleReturnMenu(ActionEvent event) throws Exception {
        SceneChanger.changeToScene(getClass(), event, "/mounira/view/user/AdminInterface.fxml");
    }
