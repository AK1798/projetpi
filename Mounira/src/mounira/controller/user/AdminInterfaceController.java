...
public class AdminInterfaceController implements Initializable {
    ...
    private void handleManageMenu(ActionEvent event) throws Exception {
        SceneChanger.changeToScene(getClass(), event, "/mounira/view/menu/AdminMenu.fxml");
    }

    @FXML
    private void handleManageIngredients(ActionEvent event) throws Exception {
        SceneChanger.changeToScene(getClass(), event, "/mounira/view/menu/AdminIngredients.fxml");
    }
