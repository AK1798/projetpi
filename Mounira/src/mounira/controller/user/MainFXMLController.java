...
public class MainFXMLController implements Initializable {
    ...
    private void GotoGestionProfil(ActionEvent event) {
        GotoFXML("/mounira/view/user/ProfilAdminFXML", "ForU", event);
    }

    @FXML
    private void GotoGestMenu(ActionEvent event) {
        GotoFXML("/mounira/view/menu/AdminMenu2", "ForU", event);
    }

    @FXML
    private void GotoEventetReser(ActionEvent event) {
        GotoFXML("/mounira/view/evenement/Evenement2", "ForU", event);
    }

    @FXML
    private void GotoGestCommande(ActionEvent event) {
        GotoFXML("/mounira/view/commandes/AdminCommande2", "ForU", event);
    ...
    private void gotousers(ActionEvent event) {
        GotoFXML("/mounira/view/user/User2", "ForU", event);
    }
